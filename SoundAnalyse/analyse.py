...
def detect_pitch(chunk, min_frequency=20.0, max_frequency=4200.0, samplerate=44100.0, sens=0.1, ratio=5.0):
    ...
    dp = analyseffi.detect_pitch(chunk, min_frequency, max_frequency, samplerate, sens, ratio)
...
def musical_detect_pitch(chunk, min_note=17.0, max_note=108.0, samplerate=44100, sens=0.1, ratio=5.0, smooth=1.0):
    '''Return the pitch present in a chunk of sampled sound
